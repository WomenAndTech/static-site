<?php
  ...
  $social_title = 'Interview with Melissa Dominguez by Kelly Seagram';
  $social_desc = 'Engineer and tech lead for Gmail for iOS at Google and leads Google Women Engineers Waterloo.';
