...
?>
  ...
  <main role="main">
    ...
    <!-- Q&A -->
    <dl class="border">
      <dt class="interview-q">What is your background?</dt>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">How did you know?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">So did you get into journalism through audio, or maybe through writing?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">You seem reticent to call yourself a creative person.</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <aside class="border pull-quote">
      <p>I'm not a gear hound; I'm more interested in the philosophical aspect of technology than the gear. I think most journalists are generalists, and too much the magpie sort of people to be totally geeky.</p>
    </aside>

    <!-- // Q & A -->
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Do you identify as a geek?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">On your CBC bio, it says you have a ‘love-hate relationship’ with technology. What do you love about technology and what do you hate about it?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <dt class="interview-q">I’m curious about the genesis of <em>Spark</em> and how you may have seen things change over the years.</dt>
      <dd class="interview-a">
    ...
    <dl class="border">
      <dt class="interview-q">How many people are on the <em>Spark</em> team?</dt>
      <dd class="interview-a">
    ...
    <dl class="border">
      <dt class="interview-q">How long would you say a single episode takes to produce?</dt>
      <dd class="interview-a">
    ...
    <dl class="border">
      <dt class="interview-q">Have people started to copy your strategy of talking about the softer side of tech, or do you feel you still have a special spot in journalism?</dt>
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Would you like to see that change?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">As part of the CBC, how do you see <em>Spark’s</em> role in creating Canadian cultural identity?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What would you say are the best CBC podcasts?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      ...
      <dd class="interview-a">
        ...
        <p>There are people at a greater distance whom I really admire. I admire <a href="http://en.wikipedia.org/wiki/Linda_Stone" title="Linda Stone's wikipedia entry" target="_blank">Linda Stone</a> as somebody who has followed her intellectual passion, and I admire the game designer <a href="http://en.wikipedia.org/wiki/Jane_McGonigal" title="Jane McGonigal's wikipedia entry" target="_blank">Jane McGonigal</a> for similar reasons – for having a real vision and not being afraid to be outside of the norm in order to pursue it, because that’s what it takes.</p>
      </dd>
    </dl>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">How do you meet the people you work with?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">It’s interesting that you say you're the world's worst networker, because you have so many conversations with different people in the work you do.</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">You have an activist sensibility that comes out in <em>The Virtual Self</em> in regards to protecting personal data. What inspired that?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Do consumers have a role to play too?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">In your book you also draw a parallel between technology and yoga, saying both can be tools to get to know yourself better. How long have you been practicing yoga?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <!-- // Pull Quote -->
    <aside class="border pull-quote">
      <p>Anyone going into journalism now should definitely learn to code, because you should be able to build apps that demonstrate what’s going on in your story, or design great data visualizations to accompany your story.</p>
    </aside>

    <!-- // Q & A -->
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Have you given any thought to applying your accumulated knowledge of technology to something you create yourself?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What upcoming projects are you excited about?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">In your career and personal life, have you ever had any experiences where you felt discrimination because you are a woman?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Is that confidence something you’ve developed over time or were you born with it?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">How can we help promote women in tech, or in journalism?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <!-- // Pull Quote -->
    <aside class="border pull-quote">
      <p>Not that I was any good at it, but if I had advice based on having not put my hand up, putting your hand up is much better.</p>
    </aside>

    <!-- // Q & A -->
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Any advice for young women just starting their careers?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <!-- // Pull Quote -->
    <aside class="border pull-quote">
      <p>It’s weird to have a big chunk of your career rest on something you have absolutely no control over. Aside from not pouring battery acid down my throat, there’s not a lot I can do about my voice.</p>
    </aside>

    <!-- // Q & A -->
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">One last question of my own: About your voice – have you done any voice training?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">In our last interview, <a href="http://womenandtech.com/interview/christina-truong/">Christina Truong</a> asked, "How do you balance work and life?"</dt>
      <!-- // Answer -->
      <dd class="interview-a">
