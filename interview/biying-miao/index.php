...
?>
  ...
  <header class="border header-interview">
      <div class="wrapper-sm">
        ...
        <p class="author">An interview with <a target="_blank" href="https://twitter.com/heyrubyjean" rel="author" title="<RUBY WATSON's twitter profile"> <strong>Ruby Watson</strong>
        </a>
