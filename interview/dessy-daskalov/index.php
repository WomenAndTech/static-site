...
?>
  <main role="main" data-interview>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What do you do?</dt>
      <!-- // Answer -->
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">How did you two form your partnership?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Did you have any early experiences with technology that have influenced your career?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Do you have any siblings?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Did you grow up in the Toronto area?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What was your experience like as an undergrad student at Queen’s?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <aside class="border pull-quote">
      <p>Be inspired by what the future holds. Make a name for yourself. Start volunteering. Do things on the side.</p>
    </aside>

    <!-- // Q & A -->
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">How would you inspire new immigrants skilled in tech who are coming to Canada looking for jobs?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Why do you work in tech?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What challenges, if any, do you face being a woman in technology? How do you attempt to overcome them?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">Do you have any role models in tech?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">How do you describe your role in tech, and do you view your role differently from your male counterparts?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What project or initiative are you most excited about in 2013?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What are your challenges in the industry?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What is your impression of developer culture? How do you think most people see developers?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <!-- // Pull Quote -->
    <aside class="border pull-quote">
      <p>Twenty years from now, it would be great to say that we built this thing and it had a positive impact in the world.</p>
    </aside>

    <!-- // Q & A -->
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">What do you hope to achieve in your career? What are your short- and long-term goals?</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
    ...
    <dl class="border">
      <!-- // Question -->
      <dt class="interview-q">In our last interview, <a href="http://womenandtech.com/interview/nora-young/">Nora Young</a> asked, “What technologies that you use allow you to best express who you really are?”</dt>
      <!-- // Answer -->
      <dd class="interview-a">
        <p>
