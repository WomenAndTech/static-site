...
<main role="main" data-interview>
  ...
  <dl class="border">
    ...
    <dd class="interview-a">
      ...
      <p>I led the research on Massive Change, identifying different areas of design for us to explore and that’s where I first came across references to Augmented Reality (AR). AR returned for me in grad school and I became fascinated by it. I remember seeing my first demo: it was very simple consisting of a blue 3D virtual cube, but it had me mesmerized! I was mesmerized that there was something in my space that wasn’t really there. It was magical. I began to ask, how can we use this new technology to tell new stories and to create compelling experiences? And these are the questions that have defined my work over the past 12 years. </p>
      <p>I went into mad scientist mode after seeing that first demo. I made things and broke things. I began to work with constraint as a design principle. When I started working with AR, there was no sound, and there were only two or three AR tracking markers, max.  Rather than using these parameters as a way to limit what I was doing, I looked at them as more of a challenge. I thought, "Okay. Within these constraints, what can I create that is compelling?""</p>
    </dd>
  </dl>
  ...
  <dl class="border">
    <!-- // Question -->
    <dt class="interview-q"><em>Dr. Helen Papagiannis will be hosting a book signing for her latest book, Augmented Human, between 7pm and 8pm at House of VR in Toronto located at 639 Queen St W. Bring your copy of the book or purchase one at the event.</em></dt>
    <!-- // Answer -->
    <dd class="interview-a">
      <p></p>
    </dd>
