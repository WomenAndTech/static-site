    ...
    <!-- Featured Image -->
      ...
      <header class="border header-interview">
        <div class="wrapper-sm">
          <h2>Sara Hicks</h2>
          <p class="intro">Sara Hicks has been an influential woman in tech since the earliest days of the web. She has held leadership roles at GeoCities, Yahoo!, Etsy, and Media Temple. Sara is the co-founder and CEO of&nbsp;<a href="https://reactioncommerce.com/">Reaction Commerce</a>, an open-source ecommerce platform.</p>
