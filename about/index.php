...
<main role="main" class="default-page">
  <article class="border">
    <div class="wrapper-sm">
      ...
      <p>However, we felt that our contributions were not enough. This project was meant to showcase gender diversity in tech. But it has become all too easy to equate diversity to mean more women and, though not necessarily intentional, mostly white women and entrepreneurs. Within our own nominations we’ve noticed this pattern. In addition to the lack of racial diversity, many other underrepresented groups and roles were not being elevated. We want to do better. Our mandate from the start was to speak to women from all walks of life. We need to be true to that mission. In our efforts to promote diversity, sometimes we fall short of the mark. But though it may get uncomfortable, improving it does start with looking at ourselves and how we can do better. We need to constantly question and critique our community, our leaders, our co-workers, our families, and ourselves. What can we do in our own circles to make a change?</p>
