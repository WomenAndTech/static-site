  ...
  <article class="border">
    ...
    <article class="border">
      <div class="wrapper-sm">
        ...
        <a href="http://www.microsoft.com/en-us/diversity/" class="no-underline"><img class="supporter-logo" src="<?php echo $path_img; ?>microsoft.png" alt="Microsoft logo"></a>
        <a href="http://camptech.ca" class="no-underline"><img class="supporter-logo" src="<?php echo $path_img; ?>camp_tech_logo.png" alt="Camp Tech logo"></a>
        <a href="http://www.ecentricarts.com/" class="no-underline"><img class="supporter-logo" src="<?php echo $path_img; ?>ecentricarts.png"alt="ecentricarts logo"></a>
        <a href="http://peopleandcode.com/" class="no-underline"></a><img class="supporter-logo" src="<?php echo $path_img; ?>peopleandcode.png" alt="People & Code logo"></a>
...
<footer class="no-border header-secondary">
  <h2>Contact Us</h2>
  <p>Follow us on <a class="white-links" href="http://twitter.com/WomenAndTech">Twitter</a>, <a class="white-links" href="http://www.facebook.com/womenandtech/">Facebook</a> and <a class="white-links" href="http://www.instagram.com/WomenAndTech/">Instagram</a>.</p>
  <p>Don't hesitate to <a class="white-links" href="mailto:contact@womenandtech.com">email us</a>.</p>
  <p>&nbsp;</p><p>&nbsp;</p>
  <h2>Want to help?</h2>
  <p><img src="<?php echo $path_img; ?>coffee-icon.png" alt="Coffee" width="50px"></p>
  <p>&nbsp;</p>
  <p><a class="white-links" href="#">Donate</a> a cup of coffee or tea.</p>
  <p>We also welcome contributors, volunteers and sponsors.</p>
  <p>Check out our <a class="white-links" href="http://womenandtech.com/contributor-guidelines/">Contribute</a> page for more information on how you can help.</p>
</footer>
